    ...
    <div class="row g-4">
        <div class="col-sm-12 col-xl-12" style="width: 95%; margin-left: 3rem;">
            <div class="bg-secondary rounded h-100 p-4">
                ...
                <a href="{{ route('site.step.div.new') }}" style="width: 190px" class="btn btn-square btn-success m-2"><i
                        class="fa fa-plus" style="padding-right: 15px"></i>ADD NEW Step</a>
            </div>
        </div>
    </div>
    <!-- Form End -->
