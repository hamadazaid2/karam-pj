        ...
        <div class="row g-4">
            <div class="col-sm-12 col-xl-12">
                <div class="bg-secondary rounded h-100 p-4">
                    <h6 class="mb-4">Edit Step</h6>
                    <form action="{{ route('site.step.div.update') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        {{-- ID --}}
                        ...
                        <div class="mb-3">
                            ...
                            <input class="form-control bg-dark" type="file" id="customerPhotoFile" name="img" value="{{ $div->img }}">
                            @error('img')
                                <small class="small-error-message">{{ $message }}</small>
                            @enderror
                        </div>
